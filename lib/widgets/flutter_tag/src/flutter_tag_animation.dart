...
import 'flutter_tag_animation_type.dart';

class FlutterTagAnimation {
  ...
  ///
  /// Some of the [TagAnimationType] cannot be used for appearance and disappearance animation.
  /// E.g. [TagAnimationType.scale] can be used, but [TagAnimationType.rotation] cannot be used.
  ...
  /// The default value is [TagAnimationType.slide].
  final FlutterTagAnimationType animationType;
  ...
  // E.x. how would you animate disappearance of [TagAnimationType.rotation]? We should use [AnimatedOpacity] for that.
  ...
  const FlutterTagAnimation.fade({
    this.toAnimate = true,
    this.animationDuration = const Duration(milliseconds: 500),
    this.loopAnimation = false,
    this.disappearanceFadeAnimationDuration = const Duration(milliseconds: 200),
    ...
    this.colorChangeAnimationCurve = Curves.linear,
    this.colorChangeAnimationDuration = Duration.zero,
  })  : animationType = FlutterTagAnimationType.fade,
        sizeTransitionAxis = null,
        sizeTransitionAxisAlignment = null,
  ...
  const FlutterTagAnimation.rotation({
    this.toAnimate = true,
    this.animationDuration = const Duration(milliseconds: 500),
    this.loopAnimation = false,
    this.disappearanceFadeAnimationDuration = const Duration(milliseconds: 200),
    ...
    this.colorChangeAnimationCurve = Curves.linear,
    this.colorChangeAnimationDuration = Duration.zero,
  })  : animationType = FlutterTagAnimationType.rotation,
        sizeTransitionAxis = null,
        sizeTransitionAxisAlignment = null,
        appearanceDisappearanceFadeAnimationEnabled = true,
        slideTransitionPositionTween = null;
